...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||'7832a64124e54c4c99970e8ea66a2f1d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AiCrackBlog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Stanley Tang', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aicrack.tech', // 网站地址
